...
export function Scanning() {
  ...
  async function runRealScan() {
    const username = (window as any).__USERNAME__ as string | undefined;
    const roots = scanRoots.length > 0
      ? scanRoots
      : ['C:\\Users\\' + (username ?? 'User') + '\\Documents'];
  ...
  function runSimulation() {
    const DEV_LINES: LogLine[] = [
      ...
      { cls: 'found', text: '✓ Klient identifikován (rodné číslo)' },
      { cls: 'found', text: '✓ Typ dokumentu: smlouva' },
      ...
      { cls: 'found', text: '✓ Typ dokumentu: faktura' },
