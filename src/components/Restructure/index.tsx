...
import { GroupDimension, DetectedCloud } from '../../types';
...
// ─────────────────────────────────────────────────────────────────────────────
// Mock file dataset for live preview (284 files)
// ─────────────────────────────────────────────────────────────────────────────
const CUSTOMERS = [
...
const INSTS  = ['ČEZ','Česká spořitelna','Kooperativa','Finanční úřad','ČSOB','Allianz','ÚSSZ'];
...
export function Restructure() {
  const {
    ...
    backupEnabled, setBackupEnabled, setPreview, detectedClouds,
  } = useStore();
  ...
  // ── Live tree from mock data ──────────────────────────────────────────────
  const tree = useMemo(() => groupBy(MOCK_FILES, structure), [structure]);
    ...
    <div className="rs-wrap">
      ...
      <div className="dest-grid">
        ...
        <div className={`dest-card ${!c2cEnabled ? 'disabled' : ''}`}
          title={!c2cEnabled ? 'Pro tento režim jsou potřeba dva cloudové klienty.' : undefined}
        >
          <div className="dest-row">
      ...
      <div className="preview-card">
        <div className="preview-stats">
          <div className="p-stat"><span className="p-stat-val c1">{MOCK_FILES.length}</span><span className="p-stat-lbl">souborů</span></div>
      ...
      <div className="rs-footer">
        ...
        <div className="footer-action">
          <div className="footer-summary">
            <div>Připraveno přesunout <strong>{MOCK_FILES.length} souborů</strong></div>
